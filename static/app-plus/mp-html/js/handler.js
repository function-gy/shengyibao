...
function createDom(nodes, parent, namespace) {
    const _loop = function _loop(i) {
        ...
        if (!node.type || node.type == 'node') {
            ...
            if (name == 'svg') namespace = 'https://www.w3.org/2000/svg'
            ...
            if (name == 'img') {
                ...
                if (!node.attrs.autoplay) {
                    ...
                    if (!node.attrs.poster) ele.setAttribute('poster', "data:image/svg+xml;utf8,<svg xmlns='https://www.w3.org/2000/svg'/>")
                }
