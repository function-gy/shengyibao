...
/***/ 0:
/*!******************************************************************!*\
  !*** /Users/gaoyang/Desktop/CODE/开放平台/tongkask-open-uni/main.js ***!
  \******************************************************************/
...
var _index = _interopRequireDefault(__webpack_require__(/*! @/util/tool/index.js */ 36));
var _uviewUi = _interopRequireDefault(__webpack_require__(/*! @/uni_modules/uview-ui */ 211));
var _index2 = _interopRequireDefault(__webpack_require__(/*! @/api/index */ 336));
var _configURl = _interopRequireDefault(__webpack_require__(/*! @/util/configURl.js */ 344));
...
_vue.default.prototype.$tool = _index.default;
_vue.default.prototype.$baseUrl = _configURl.default.baseUrl;
_vue.default.prototype.$appid = _configURl.default.appid;
_App.default.mpType = 'app';
var smjloading = function smjloading() {
  __webpack_require__.e(/*! require.ensure | components/smj-loading/index */ "components/smj-loading/index").then((function () {
    return resolve(__webpack_require__(/*! @/components/smj-loading/index.vue */ 576));
  }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
};
_vue.default.component('smjloading', smjloading);

// 引入uView对小程序分享的mixin封装
var mpShare = __webpack_require__(/*! @/uni_modules/uview-ui/libs/mixin/mpShare.js */ 345);
...
__webpack_require__(/*! ./request/http.js */ 346)(app);
createApp(app).$mount();
...
/***/ 27:
/*!******************************************************************!*\
  !*** /Users/gaoyang/Desktop/CODE/开放平台/tongkask-open-uni/App.vue ***!
  \******************************************************************/
/*! no static exports found */
...
/***/ 28:
/*!*******************************************************************************************!*\
  !*** /Users/gaoyang/Desktop/CODE/开放平台/tongkask-open-uni/App.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 29:
/*!**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--13-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/gaoyang/Desktop/CODE/开放平台/tongkask-open-uni/App.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
      ...
      this.$api.home.homeInfo.post().then(function (res) {
        if (res.code == 0) {
          ...
          if (res.data && res.data.home_style && res.data.home_style.login_config) {
            ...
            _this2.$store.commit('SET_myStyle', myStyle);
            uni.setStorageSync(_this2.$tool.setStorageLocKey('myStyle'), myStyle);
            uni.setStorageSync(_this2.$tool.setStorageLocKey('logincolor'), login_config.color);
            var colorobj = {
              'logincolor': login_config.color,
              'logincolor-lighten-1': _color.default.lighten(login_config.color, 0.3),
              'logincolor-darken-1': _color.default.darken(login_config.color, 0.2)
            ...
            if (homeinfo.app_list && homeinfo.app_list.length > 0) {
              uni.setStorageSync(_this2.$tool.setStorageLocKey('mallAppList'), JSON.stringify(homeinfo.app_list));
            } else {
              uni.setStorageSync(_this2.$tool.setStorageLocKey('mallAppList'), JSON.stringify([]));
            }
            ...
            if (diy_config && diy_config.length > 0) {
              uni.setStorageSync(_this2.$tool.setStorageLocKey('homeRoleList'), JSON.stringify(diy_config.map(function (item) {
                return item.components;
              })));
            } else {
              uni.setStorageSync(_this2.$tool.setStorageLocKey('homeRoleList'), JSON.stringify([]));
            }
            _this2.$store.commit('SET_configthemp', colorobj);
            uni.setStorageSync(_this2.$tool.setStorageLocKey('configthemp'), colorobj);
            _this2.$store.commit('SET_HOMEINFO', JSON.stringify(res.data));
            uni.setStorageSync(_this2.$tool.setStorageLocKey('homeInfo'), JSON.stringify(res.data));
      ...
      this.$api.home.homeInfo.post().then(function (res) {
        if (res.code == 0) {
          ...
          if (res.data && res.data.home_style && res.data.home_style.login_config) {
            ...
            var myStyle = "\n\t\t\t\t\t\t--logincolor:" + login_config.color + ";\n\t\t\t\t\t\t--logincolor-lighten-1:" + _color.default.lighten(login_config.color, 0.3) + ";\n\t\t\t\t\t\t--logincolor-darken-1:" + _color.default.darken(login_config.color, 0.2) + ";\n\t\t\t\t\t\t";
            _this3.$store.commit('SET_myStyle', myStyle);
...
/***/ 31:
/*!****************************************************************************************************!*\
  !*** /Users/gaoyang/Desktop/CODE/开放平台/tongkask-open-uni/App.vue?vue&type=style&index=0&lang=scss& ***!
  \****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 32:
/*!********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--8-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--8-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-2!./node_modules/postcss-loader/src??ref--8-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/sass-loader/dist/cjs.js??ref--8-oneOf-1-4!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-5!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/gaoyang/Desktop/CODE/开放平台/tongkask-open-uni/App.vue?vue&type=style&index=0&lang=scss& ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
